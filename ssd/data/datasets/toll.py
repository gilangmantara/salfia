...
class TOLLDataset(torch.utils.data.Dataset):
    class_names = ('__background__', '1', '2', '3', '4', '5')

    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        """Dataset for Toll data.
        Args:
            data_dir: the root of the Toll dataset, the directory contains the following sub-directories:
        ...
        self.ids = TOLLDataset._read_image_ids(image_sets_file)
    ...
    def _get_annotation(self, image_id):
        ...
        for obj in objects:
            ...
            # TOLL dataset format follows Matlab, in which indexes start from 0
